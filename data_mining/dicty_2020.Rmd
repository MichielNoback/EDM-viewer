...
filter_data_and_plot('dicty', bait_in = 'Galpha8')
filter_data_and_plot('dicty', condition_in = 'Normal')
filter_data_and_plot('dicty', uniprot_id = 'GST')
filter_data_and_plot('dicty', uniprot_id = 'Q54YT4')
filter_data_and_plot('neutro', uniprot_id = 'GST')
filter_data_and_plot('dicty', bait_in = 'Galpha8', experiment = TRUE)
...
filter_data_and_plot('neutro', uniprot_id = 'P36415', normalized = TRUE)
filter_data_and_plot('neutro', uniprot_id = 'RASC', normalized = TRUE)

filter_data_and_plot('dicty', bait_in = 'Galpha8', experiment = TRUE, viz_type = 'box')
