...
# resulting in 17k+ edges, hairball!, need to filter
new_x <- x %>% filter(spectral_count > 500)
...
my_edges <- as.data.frame(new_x$bait_condition)
my_edges$to <- new_x$genid 
colnames(my_edges) <- c('from', 'to')
